...
const EnfermagemScreen = () => {
  ...
  return (
     ...
     <TouchableOpacity onPress={handleGoBack} style={styles.closeButton}>
        ...
        <Text style={styles.profileText}>Enfermagem</Text>
        <View style={styles.headerRight}></View>
        <View style={styles.separator} />
    <View style={styles.containerAll}>
      <Text style={styles.header}>Página de Agendamento - Enfermagem</Text>
                <Spacer height={30} />
...
export default EnfermagemScreen;